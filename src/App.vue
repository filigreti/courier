<template>
  <main class="w-full lg:px-16 px-6">
    <div class="w-full">
      <div
        class="fixed flex pt-5 w-to8 bg-white flex-wrap justify-between items-center z-10"
      >
        <div @click="send" class="flex items-center cursor-pointer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="w-24"
            viewBox="0 0 448.882 101.963"
          >
            <g transform="translate(18361.592 9503)">
              <g transform="translate(-18219.986 -9492.442)">
                <path
                  ...
                  transform="translate(0 -87.166)"
                  fill="#104c93"
                />
                <path
                  d="M688.344,144.145H672.47V65.63h15.874Z"
                  transform="translate(-598.513 -64.043)"
                  fill="#104c93"
                />
                <path
                  d="M885.942,67.125a9.462,9.462,0,1,1,6.616,2.7A8.99,8.99,0,0,1,885.942,67.125ZM900.494,131.3H884.62V74.376h15.874Z"
                  transform="translate(-786.112 -51.2)"
                  fill="#104c93"
                />
                <path
                ...
                <path
                  ...
                  transform="translate(-1690.313 -64.043)"
                  fill="#104c93"
                />
                <path
                  d="M2429.8,144.145H2413.93V65.63H2429.8Z"
                  transform="translate(-2148.452 -64.043)"
                  fill="#104c93"
                />
                <path
                  d="M2627.322,67.125a9.462,9.462,0,1,1,6.616,2.7A8.981,8.981,0,0,1,2627.322,67.125Zm14.553,64.177H2626V74.376h15.874Z"
                  transform="translate(-2335.971 -51.2)"
                  fill="#104c93"
                />
              </g>
              <g transform="translate(-18361.592 -9503)">
                <path
                  d="M1627.738,1752.23a2.92,2.92,0,0,1-.478.478v-.478Z"
                  transform="translate(-1561.748 -1686.365)"
                  fill="#a1a3a6"
                />
                <path
                  d="M1155.368,1280.3v.478h-.478A5.69,5.69,0,0,1,1155.368,1280.3Z"
                  transform="translate(-1109.169 -1234.208)"
                  fill="#a1a3a6"
                />
                <path
                  d="M1154.89,1752.23h.478v.478A5.706,5.706,0,0,1,1154.89,1752.23Z"
                  transform="translate(-1109.169 -1686.365)"
                  fill="#a1a3a6"
                />
                <path
                  d="M1627.738,1280.778h-.478v-.478A2.915,2.915,0,0,1,1627.738,1280.778Z"
                  transform="translate(-1561.748 -1234.207)"
                  fill="#a1a3a6"
                />
                <path
                  ...
                  transform="translate(-63.62 -180.16)"
                  fill="#104c93"
                />
                <path
                  ...
                  transform="translate(-838.965 -981.843)"
                  fill="#0ebbbc"
                />
              </g>
            </g>
...
<style>
.bge {
  box-shadow: 0px 12px 18px rgba(41, 94, 255, 0.05);
  border-radius: 3px;
  background: white;
}
</style>